...
function scriptGetVideo() {
    const title = document.getElementsByClassName('lcd lcd__music')[0].shadowRoot.querySelectorAll('.lcd-meta__primary > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(1) > span:nth-child(1)')[0].innerText;
    const creator = document.getElementsByClassName('lcd lcd__music')[0].shadowRoot.querySelectorAll('.lcd-meta__secondary > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(1)')[0].innerText.split('\n')[0];
    const artLink = document.getElementsByClassName('lcd lcd__music')[0].shadowRoot.querySelectorAll('.lcd__artwork-img')[0].src;
    info.video = {
        'creator': creator,
        'title': title,
        'thumbnail': artLink,
...
function main() {
    ...
    const observer = new MutationObserver((_mutationList, _observer) => { clientSendData(); });
